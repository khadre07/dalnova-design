...
/* Le registre des partenaires, qui défile.

   Il défile horizontalement, en boucle, et s'arrête dès qu'on le survole ou
   qu'on l'atteint au clavier — un registre qui bouge pendant qu'on essaie de
   lire une entrée est un registre qu'on ne peut ni lire ni cliquer.

   Les plaques sont en volume : le rail porte une perspective et chaque plaque
   est tournée sur son axe vertical, avec une tranche pour lui donner une
   épaisseur. Ce sont donc des panneaux qui passent, et non des vignettes qui
   glissent.

   J'étais passé par un anneau tournant avant d'en revenir : ce n'était pas ce
   qu'on demandait. Ce qu'on demandait, c'est ce défilement-ci, avec ces
   rectangles-là en trois dimensions.
