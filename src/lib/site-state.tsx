...
export function SiteProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const read = () => {
      ...
      /* La position de défilement n'est plus publiée ici.

         Elle l'était, sur documentElement, et c'était une erreur mesurable :
         une propriété personnalisée sur la racine invalide le style de tout ce
         qui en hérite. Soixante-dix-sept recalculs de style et près d'une
         seconde de plus par défilement, pour déplacer un seul élément. La
         figure écrit maintenant son propre décalage sur elle-même. */
    };
    const onScroll = () => {
